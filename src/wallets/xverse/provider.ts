...
import XverseWallet from './controller';
import { XverseBitcoinProvider } from './interface';

export class XverseProvider implements Unisat {
    private wallet: XverseBitcoinProvider

    constructor(wallet: XverseBitcoinProvider) {
        this.wallet = wallet
    }
